            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl">
                    <h3 className="text-white text-3xl font-semibold sm:text-4xl">
                       {user!==null ? (<h1>Welcome {user.name}</h1>):(<h1>Welcome to Recipe Finder <strong className="text-3xl text-red-400">(GUEST)</strong></h1> )}
                    </h3>
                    <br />
                    <p className="text-white mt-3">
                       This is best place to find a new and amazing recipe for cooking food, Hope you like it more ! <br /><br /> Thank you so much for spending time here.
                    </p>
                </div>
                <div className="mt-12">
